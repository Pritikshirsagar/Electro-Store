...
<div class="container">    
  <div class="row">
	<?php 
		$sql="select * from tbl_product where name like '%$search%' or category like '%$search%'  or subcategory like '%$search%' "; 
					...
					<div class="col-sm-4"> 
					  <div class="panel panel-danger">
						...
						<div class="panel-footer">
							...
							<b>After Discount Price:  </b><?php echo $row['after_discount'];?><br>
							...
							{  ?>
                                      <p><a href="index.php?id=<?php echo $id; ?>"role="button" class="btn btn-primary btn-block">Buy Now<br><small>You Must Login First </small></a></p>
                                        <?php
												...
												{
													?>
													<p><a href="Clothing.php?pid=<?php Echo $row["id"];?>" class="btn btn-block btn-primary " name="add" value="add" class="btn btn-block btr-primary">Buy Now</a>
													<?php
												}
                                        }
                                        ?>
